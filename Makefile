...
objects = $(http_parser)http_parser.o $(adresse_internet)adresse_internet.o $(socket_tcp)socket_tcp.o $(mime_type)mime_type.o $(dir_index)dir_index.o http_server.o 
